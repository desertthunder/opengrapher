...
export const IBM: FontPreset = {
  name: "IBM",
  typography: { heading: "IBM Plex Serif", sans: "IBM Plex Sans", mono: "IBM Plex Mono" },
  fonts: [{
    provider: "fontsource",
...
export const Vercel: FontPreset = {
  name: "Vercel",
  typography: { heading: "Instrument Serif", sans: "Geist Sans", mono: "Geist Mono" },
  fonts: [{
    provider: "fontsource",
...
export const Monaspace: FontPreset = {
  name: "Monaspace",
  typography: { heading: "Monaspace Radon", sans: "Monaspace Neon", mono: "Monaspace Argon" },
  fonts: [{
    ...monaspaceRelease,
...
export const fontPresets = { IBM, Vercel, Monaspace } as const;
